        ...
        <div className="bg-gray-300/50">
            <div className="flex flex-row items-center justify-between px-60 py-40">
                <div className="flex flex-col">
                    ...
                    <br />
                    <span><a href="#" className="hover:underline font-medium">HOME</a></span>
                    <span><a href="#" className="hover:underline font-medium">ABOUT</a></span>
                ...
                <div className="flex flex-col">
                    ...
                    <br />
                    <span><a href="#" className="hover:underline font-medium">LinkedIn</a></span>
                    <span><a href="#" className="hover:underline font-medium">Instagram</a></span>
                    <span><a href="#" className="hover:underline font-medium">Facebook</a></span>
                    <span><a href="#" className="hover:underline font-medium">X (previously Twitter)</a></span>
                </div>            
            </div>
        </div>
    )
