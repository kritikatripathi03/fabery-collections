    ...
    <nav className="w-full bg-transparent mt-4 px-4 py-4">
      <div className="flex items-center justify-between px-4">
        <div className="hidden lg:flex gap-6 text-xl">
          <span className="px-2 font-bold hover:font-extrabold"><a href="#">Home</a></span>
          <span className="px-2 font-bold hover:font-extrabold"><a href="#">Collections</a></span>
          <span className="px-2 font-bold hover:font-extrabold"><a href="#">New</a></span>
        </div>
